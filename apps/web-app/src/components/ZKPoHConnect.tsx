...
import { Prover, ProverProps, Register, RegisterProps,NewIdentityProps,IdentityGenerator } from "@/widget";
import { WalletAccountSwitcher, WalletChainSwitcher, WalletConnect } from "zkpoh-button";
